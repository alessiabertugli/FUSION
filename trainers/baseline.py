...
from datasets.datasetfactory import get_dataset, cactus
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--num_partitions', type=int,
                           ...
                           default=1)
    argparser.add_argument('--scaled_encodings', action="store_false",
                           help='if True, use randomly scaled encodings for kmeans')
